...
(function () {
  ...
  var html = ""
    ...
    + "<button type='submit' id='wlw-btn'>שליחה</button>"
    + "<p class='wl-msg' id='wlw-msg' role='status' aria-live='polite'></p>"
    + "</form>"
    + "<div class='wl-done'><div class='wl-big'>🎉</div><h2>תודה! קיבלנו את הפרטים.</h2><p class='wl-sub' style='margin:0'>נחזור אליכם בהקדם.</p></div>"
    + "</div>";

  function init() {
    if (document.getElementById('wl-widget')) return;
    ...
    var f = document.getElementById('wlw-form');
    var msg = document.getElementById('wlw-msg');
    var btn = document.getElementById('wlw-btn');
